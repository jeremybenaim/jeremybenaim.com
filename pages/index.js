...
const Index = () => {
  ...
  return (
    <>
      ...
      <article>
        <p>Hi, I'm Jeremy. I build stuff for the internet.</p>
        <p>I've been a <strong>Full Stack Javascript developer</strong> since 2008. My job is to help companies around the world to build successful products and deliver great user experiences.</p>
        <p>I have considerable expertise in Javascript development with <strong>react</strong>, <strong>redux</strong>, <strong>nodejs</strong> and <strong>react-native</strong> and have worked with a number of different frameworks and languages throughout my career.</p>
